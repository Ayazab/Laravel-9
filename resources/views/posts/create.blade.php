  ...
  <body>
    ...
    <div class="col-md-6 offset-3 mt-5">
        ...
        <form method="POST" action="{{ route('posts.store')}}" id="form">
            ...
            <div class="mb-3">
              <label>Title</label>
              <input  type="title" name="title" placeholder="Enter title here" class="form-control" value="{{old('title')}}">
            </div>
            <div class="mb-3">
                <label>Description</label>
                <textarea required type="desc" name="description" placeholder="Write Desc here..." class="form-control">{{old('description')}}</textarea>
            </div>
            <div class="mb-3">
